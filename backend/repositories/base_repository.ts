import { BaseRepositoryInterface, PaginatedResult, QueryOptions } from "../types/base_repository";
...
export default class BaseRepository<T> implements BaseRepositoryInterface<T>{
    ...
    async findById(id: number | string, include?: Record<string, boolean>): Promise<T | null> {
